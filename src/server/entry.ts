...
import chatAskPost from "./api/chat/ask/POST";
import chatHistoryGet from "./api/chat/history/GET";
import knowledgeGet from "./api/knowledge/GET";
import adminDocsGet from "./api/admin/documents/GET";
import adminDocsUploadPost from "./api/admin/documents/upload/POST";
import adminDocsDeletePost from "./api/admin/documents/delete/POST";
import adminOpenAIKeyGet from "./api/admin/openai-key/GET";
import adminOpenAIKeyPost from "./api/admin/openai-key/POST";
import adminOpenAIKeyDelete from "./api/admin/openai-key/DELETE";
import adminAIProviderPost from "./api/admin/ai-provider/POST";
// </api-imports>
...
app.post("/api/auth/register", authRegisterPost);
app.post("/api/auth/login", authLoginPost);
app.get("/api/auth/me", ...(authMeGet as any).middleware, authMeGet);
app.post("/api/chat/ask", ...(chatAskPost as any).middleware, chatAskPost);
app.get("/api/chat/history", ...(chatHistoryGet as any).middleware, chatHistoryGet);
app.get("/api/knowledge", ...(knowledgeGet as any).middleware, knowledgeGet);
// Admin routes
app.get("/api/admin/documents", ...(adminDocsGet as any).middleware, adminDocsGet);
app.post("/api/admin/documents/upload", ...(adminDocsUploadPost as any).middleware, adminDocsUploadPost);
app.post("/api/admin/documents/delete", ...(adminDocsDeletePost as any).middleware, adminDocsDeletePost);
app.get("/api/admin/openai-key", ...(adminOpenAIKeyGet as any).middleware, adminOpenAIKeyGet);
app.post("/api/admin/openai-key", ...(adminOpenAIKeyPost as any).middleware, adminOpenAIKeyPost);
app.delete("/api/admin/openai-key", ...(adminOpenAIKeyDelete as any).middleware, adminOpenAIKeyDelete);
app.post("/api/admin/ai-provider", ...(adminAIProviderPost as any).middleware, adminAIProviderPost);
// </api-registrations>
